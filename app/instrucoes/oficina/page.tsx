      ...
      <Container>
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="text.primary">
            Instruções - Participação em Minicurso/Oficina
          </Typography>
        </Breadcrumbs>
        <h2 className="mb-4">Participação em Minicurso/Oficina</h2>
        <Row className="w-100 py-4 px-2 container-instrucao">
          <p className="text-default">
            A inscrição em Minicurso é específica. Para tanto, deverá
            inscrever-se no campo Minicurso da Ficha de Inscrição,
            adicionando-se o valor do minicurso ao boleto bancário. A inscrição
            em Minicurso não isenta o valor de inscrição em outras modalidades
            de participação.
          </p>
          <p className="text-default">
            <b>
